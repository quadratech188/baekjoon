...
def main():
    ...
    used = set((initial_board.red_pos, initial_board.blue_pos))
    ...
    while True:
        ...
        for translate in translates:
            ...
            success = board_copy.move_marbles(translate)
            
            if not success and (board_copy.red_pos, board_copy.blue_pos) in used:
                continue
            ...
            if success is not False:
                used.add((board_copy.red_pos, board_copy.blue_pos))
