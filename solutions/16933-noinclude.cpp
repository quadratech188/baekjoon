...
public:
	...
	class child {
	public:
		child(GridGraph& graph, Int2 index):
	...
	public:
		...
		edge_t& edge() {
			static std::monostate placeholder;
			return placeholder;
		}
		vertex_t& value() {
			return graph[_index];
	...
	auto children(index_t parent) {
		...
		return deltas | std::views::filter([this, parent](Int2 delta) {
				return this->data.bounds().contains(parent + delta);
				}) | std::views::transform([this, parent](Int2 delta) {
